...
public class BigTextIntentService extends IntentService {
    ...
    private void handleActionDismiss() {
        ...
        notificationManagerCompat.cancel(MainActivity.Companion.getNOTIFICATION_ID());
    }
...
//        Notification.Builder x = null;
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
//            x.setAllowSystemGeneratedContextualActions(true)
//        }
        ...
        if (notification != null) {
            ...
            notificationManagerCompat.notify(MainActivity.Companion.getNOTIFICATION_ID(), notification);
        }
