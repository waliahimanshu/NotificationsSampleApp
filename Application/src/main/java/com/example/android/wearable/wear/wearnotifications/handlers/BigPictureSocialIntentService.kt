...
class BigPictureSocialIntentService : IntentService("BigPictureSocialIntentService") {
    ...
    private fun handleActionComment(comment: CharSequence?) {
        ...
        if (comment != null) {
            ...
            var notificationCompatBuilder: NotificationCompat.Builder? = GlobalNotificationBuilder.getNotificationCompatBuilderInstance()
            ...
            val updatedNotification = notificationCompatBuilder
    ...
    companion object {
        ...
        private val TAG = "BigPictureService"

        val ACTION_COMMENT = "com.example.android.wearable.wear.wearnotifications.handlers.action.COMMENT"

        val EXTRA_COMMENT = "com.example.android.wearable.wear.wearnotifications.handlers.extra.COMMENT"
    }
}
