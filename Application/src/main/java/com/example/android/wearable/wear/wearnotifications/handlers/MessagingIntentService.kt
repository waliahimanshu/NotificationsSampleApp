...
class MessagingIntentService : IntentService("MessagingIntentService") {
    ...
    companion object {
        ...
        private val TAG = "MessagingIntentService"

        val ACTION_REPLY = "com.example.android.wearable.wear.wearnotifications.handlers.action.REPLY"

        val EXTRA_REPLY = "com.example.android.wearable.wear.wearnotifications.handlers.extra.REPLY"
    }
}
