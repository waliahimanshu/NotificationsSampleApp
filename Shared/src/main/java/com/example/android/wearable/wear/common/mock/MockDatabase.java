...
public final class MockDatabase {
    ...
    public static MediaStyleReminderAppData getMediaStyleData() {
        return MediaStyleReminderAppData.getInstance();
    }
    ...
    /** Represents data needed for BigTextStyle Notification. */
    public static class MediaStyleReminderAppData extends MockNotificationData {

        private static MediaStyleReminderAppData sInstance = null;
        ...
        public static MediaStyleReminderAppData getInstance() {
            if (sInstance == null) {
                sInstance = getSync();
            }
        ...
        private static synchronized MediaStyleReminderAppData getSync() {
            if (sInstance == null) {
                sInstance = new MediaStyleReminderAppData();
            }

            return sInstance;
        }

        private MediaStyleReminderAppData() {
            ...
            // BigText Style Notification values:
            mBigContentTitle = "Media style content title";
            mBigText = "Media style content title";
            mSummaryText = "Media style summary text";
    ...
    public static class BigPictureStyleSocialAppData extends MockNotificationData {
        ...
        private BigPictureStyleSocialAppData() {
            ...
            mContentText = "Like my shot of Earth?";
            mPriority = NotificationCompat.PRIORITY_HIGH;
